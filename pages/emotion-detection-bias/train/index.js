                    ...
                    <div className='container'>
                        <div className='row'>
                            <div className='col-sm-6' style={{textAlign:'center',marginTop:'10px'}}>
                                <button className={styles["btn_style"]} onClick={()=>trainModel(1)}>Train Dataset-1</button>
                            </div>
                            <div className='col-sm-6' style={{textAlign:'center',marginTop:'10px'}}>
                                <button className={styles["btn_style"]} onClick={()=>trainModel(0)}>Train Dataset-2</button>
                            </div>
                        </div>
                    </div>
                </div>
