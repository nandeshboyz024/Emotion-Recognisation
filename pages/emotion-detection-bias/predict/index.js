...
import Sidebar from '../../../components/emotion-detection-bias/Sidebar'
                                                ...
                                                <div className="container mb-3">
                                                    <div className="row">
                                                        <div className="col-sm-6 mt-3">
                                                            <select name="query" id={styles["id_query"]}  value={formData.query} onChange={handleInputChange}>
                                                        ...
                                                        <div className="col-sm-6 mt-3">
                                                            <select name="dataset" id={styles["id_dataset"]} value={formData.dataset} onChange={handleInputChange}>
                                                    ...
                                                    <input id={styles["predict"]} type="submit" value="Predict"/>
                                            </form>
