        ...
        <div className="container-fluid">
            <div className="row">
                ...
                <div className="col-sm-9">
                    ...
                    <div className={styles["card"]} id = "mydiv" style={{marginTop:'20px',paddingBottom:'10px',position: 'relative',zIndex:'1'}}>  
                            ...
                            <div className="container">
                                <div className="row" style={{marginLeft:'5px'}}>
                                    <div className="col-lg-4" style={{textAlign:'center'}} >
                                        ...
                                        <select name="emotion" id={styles["emotion"]} value={emotion} onChange={handleEmotionOnChange}>
                                    ...
                                    <div className="col-lg-8" style={{textAlign:'center'}}>
                                        ...
                                        <textarea className= {styles['textarea']}  id="myText" style={{height: '100px',width:'90%'}} value={text} onChange={handleTextOnChange}></textarea>
                                        <input className={styles["btn_style"]} id="add_data" type="submit" value="Add Data"/>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div style={{marginTop:'20px',display: 'flex', justifyContent: 'space-between',alignItems: 'center'}}>
                        <button className={styles["btn_style"]} id="showmy" onClick={toggleData}>Show My Data</button>
                        <button className={styles["btn_style"]} id="resetmy" onClick={resetData}>Reset My Data</button>
                    </div>
                    <div>
                        {alert && (
                            ...
                            (
                                <div>
                                    <div style={{textAlign:'center'}}>
                                        <button className={styles["btn_style"]} id="popmy" onClick={deleteLastEntry} >Delete Your Last Entry</button>
                                    </div>
                                    <div className={styles["my_data_cls"]} style={{marginTop:'15px'}}>
